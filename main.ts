...
function giveIntroduction () {
    ...
    showInstruction("Jump with the up or A(Z/SPACE) button.")
...
function animateIdle () {
    ...
    mainIdleLeft.addAnimationFrame(img`
        ...
        . f b b b b b b b b b e e b f . 
        . f b b c b b b b c b b e b f . 
        . f b b c b b b b c b b b e f . 
        . f b b c b b b b c b b b f . . 
        . f b b b b b b b b b b b f . . 
        . f a c c c c c c c c a a f . . 
        . f b b c c c c c c b b b f . . 
        . f b f f f b b f f f b b f . . 
    ...
    mainIdleRight.addAnimationFrame(img`
        ...
        . . f e e e e e e e e e e f . . 
        . f e e e e e e e e e e e e f . 
        . f b e e b b b b b b b b b f . 
        . f b e b b c b b b b c b b f . 
        . f e b b b c b b b b c b b f . 
        . . f b b b c b b b b c b b f . 
        . . f b b b b b b b b b b b f . 
        . . f a a c c c c c c c c a f . 
        . . f b b b c c c c c c b b f . 
        . . f b b f f f b b f f f b f . 
        . . f a a a a a a a a a a f . . 
        . . . f b a a f f b a a f . . . 
        . . . f b a a f f b a a f . . . 
        . . . . f f f . . f f f . . . . 
...
function setLevelTileMap (level: number) {
    tiles.placeOnRandomTile(hero, assets.tile`tile3`)
    clearGame()
    if (level == 0) {
...
function animateRun () {
    ...
    mainRunLeft.addAnimationFrame(img`
        ...
        . f b b b b e b b e e f . . . . 
        . f b b c b b e b e e f . . . . 
        . f b b c b b b e e e f . . . . 
        . f b b c b b b b b b f . . . . 
    ...
    mainRunRight.addAnimationFrame(img`
        ...
        . . . . . f e e e e e e e f . . 
        . . . . f e e e e e e e e e f . 
        . . . . f e e b b e b b b b f . 
        . . . . f e e b e b b c b b f . 
        . . . . f e e e b b b c b b f . 
        . . . . f b b b b b b c b b f . 
        . . . . f b b b b b b b b b f . 
        . . . . f b c c a a c c c f . . 
        . . . . f b c c b b b c c f . . 
        . . . . f f f f b b f f b f . . 
...
function animateJumps () {
    ...
    for (let index = 0; index < 30; index++) {
        mainJumpLeft.addAnimationFrame(img`
            ...
            . b a 3 c c c c c c c c 3 a b . 
            . b a c c c c c c c c c c a b . 
...
function animateCrouch () {
    ...
    mainCrouchLeft.addAnimationFrame(img`
        ...
        . f b b b b b b b b b b b f . . 
        . f a c c c c c c c c a a f . . 
        . f b c c c c c c c c c b b f . 
        f b b f f f b b f f f f b b f . 
    ...
    mainCrouchRight.addAnimationFrame(img`
        ...
        . . f b b b b b b b b b b b f . 
        . . f a a c c c c c c c c a f . 
        . f b b c c c c c c c c c b f . 
        . f b b f f f f b b f f f b b f 
...
function createEnemies () {
    ...
    for (let value5 of tiles.getTilesByType(assets.tile`tile11`)) {
    ...
    for (let value6 of tiles.getTilesByType(assets.tile`tile17`)) {
...
function initializeLevel (level: number) {
    ...
    playerStartLocation = tiles.getTilesByType(assets.tile`tile3`)[0]
